...
def main_menu():
    while True:
        ...
        background = pygame.image.load("C:/Users/ValeriaBravo/Documents/PROYECTOS PYTHON/Proyecto TEA/Imagenes/fondo_pantalla.jpg")
        ...
        draw_text("Circuito de obstáculos", font_bold, black, screen, screen_width // 2, 530)
        draw_text("Juego de emparejamiento", font_bold, black, screen, screen_width // 2, 630)
